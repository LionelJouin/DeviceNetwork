...
func TestHostDevice_IsSupported(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			hostDevice: &host.Device{Spec: host.DeviceSpec{InterfaceName: "dn-test-br0", LinkLayerType: "ether", DeviceType: "bridge"}},
			deviceConfiguration: &v1alpha1.DeviceConfiguration{
				DeviceType: ptr.To(v1alpha1.DeviceTypeHostDevice),
			},
			want: false,
		},
		{
			...
			hostDevice: &host.Device{Spec: host.DeviceSpec{InterfaceName: "dn-test-tun", LinkLayerType: "ether", DeviceType: "tuntap"}},
			deviceConfiguration: &v1alpha1.DeviceConfiguration{
				DeviceType: ptr.To(v1alpha1.DeviceTypeHostDevice),
			},
			want: false,
		},
		{
			...
			hostDevice: &host.Device{Spec: host.DeviceSpec{InterfaceName: "dn-test-mcvln", LinkLayerType: "ether", DeviceType: "macvlan", ParentIndex: 3}},
			deviceConfiguration: &v1alpha1.DeviceConfiguration{
				DeviceType: ptr.To(v1alpha1.DeviceTypeHostDevice),
			},
			want: false,
